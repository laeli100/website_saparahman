...
<div class="container">
    ...
    <form action="{{ route('surah.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="nama_surah" value="{{ old('nama_surah') }}">
        </div>

        <div class="mb-3">
            <label for="arti_surah" class="form-label">Arti Surah</label>
            <input type="text" class="form-control" name="arti_surah" value="{{ old('arti_surah') }}">
        </div>

        <div class="mb-3">
            <label for="jml_ayat" class="form-label">Jumlah Ayat</label>
            <input type="number" class="form-control" name="jml_ayat" value="{{ old('jml_ayat') }}">
        </div>
